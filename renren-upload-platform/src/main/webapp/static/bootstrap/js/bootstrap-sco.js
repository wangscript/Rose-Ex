...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			$modal = $('<div class="modal" id="' + this.options.target.substr(1) + '"><div class="modal-body inner"/><div class="modal-footer"><a class="btn cancel" href="#" data-dismiss="modal">取消</a> <a href="#" class="btn btn-primary" data-action="1">确定</a></div></div>').appendTo(this.options.appendTo).hide();
	...
	$.extend(Confirm.prototype, {
		...
		,loading: function(){
			try{
				this.scomodal.show();
				$("#confirm_modal .modal-footer")[0].innerHTML = '<a href="#" class="btn btn-primary disabled" data-action="1">正在提交...</a>';
            }catch(e){}
			return this;
		}
